                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    // 'ID Pasien: ${booking.patientId}',
                                    'Pasien: ${booking.patientName ?? 'Tidak diketahui'}',
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                    'Usia: ${booking.patientAge != null ? '${booking.patientAge} tahun' : 'Tidak diketahui'}',
                                    style: TextStyle(
                                      fontSize: 14,
                                    ),
                                  ),
                                  ...
                                  Text(
                                    // 'ID Dokter: ${booking.doctorId}',
                                    'Dokter: ${booking.doctorName ?? 'Nama Tidak Diketahui'}',
                                    style: TextStyle(
                                      fontSize: 14,
                                    ),
                                  ),
                                  SizedBox(height: 4),
                                  Text(
                                    'Spesialis: ${booking.doctorSpecialty ?? 'Spesialis Tidak Diketahui'}',
                                    style: TextStyle(
                                      fontSize: 14,
                                    ),
                                  ),
